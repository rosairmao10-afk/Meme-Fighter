...
const CHARACTERS = [
    {
        ...
        displayWidth:  220,
        stats: { velocidade: 50, poder: 85, defesa: 65, dificuldade: 2 }
    },
    {
        name:          'NYAN CAT',
        shortName:     'NYAN CAT',
        ...
        displayWidth:  220,
        stats: { velocidade: 100, poder: 60, defesa: 40, dificuldade: 2 }
    },
    {
        name:          'TROLL FACE',
        ...
        specialName:   'Problem?',
        displayWidth:  180,
        stats: { velocidade: 70, poder: 60, defesa: 70, dificuldade: 3 }
    },
    {
        ...
        displayWidth:  140,
        stats: { velocidade: 50, poder: 50, defesa: 100, dificuldade: 5 }
    },
    {
        ...
        displayWidth:  145,
        stats: { velocidade: 40, poder: 95, defesa: 65, dificuldade: 3 }
    },
    {
        ...
        displayWidth:  250,
        stats: { velocidade: 95, poder: 60, defesa: 500, dificuldade: 4 }
    }
];
